    ...
    <div className='relative w-full max-w-2xl'>
        <form className="relative">
            <div className='relative group'>
                ...
                focus:ring-white/30 focus:border-white/40 transition-all duratino-300 hover:bg-white/15" 
                placeholder="search for any city worldwide...."/>
                
                <button className='absolute right-14 top-1/2 transform -translate-y-1/2 text-white/50 hover:text-white transition-all p-1
        ...
        <div className='absolute top-full left-0 right-0 mt-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl 
        overflow-hidden z-50 '>
            ...
            border-white/10 last:border-b-0 '>
